...
{
    public function getVfMallOrders($token, $shipmentStatus = "", $status = "", $shoppingCartId, $createdDateStart = "", $createdDateEnd = "", $updatedDateStart = "", $updatedDateEnd = "", $page = 0, $size = 1)
    {
        ...
        return json_decode(Request::VodafoneRequest("getVfMallOrders", $arrayData, $this->test, $token, "GET"));
    }
}
